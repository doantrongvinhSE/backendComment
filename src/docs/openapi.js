      ...
      RealtimeDocs: {
        ...
        example: {
          ...
          events: {
            ...
            'order.created': { payload: { order: { id: 1, product_name: 'Áo thun', customer_name: 'Nguyễn Văn A', phone: '0900000000', address: 'Hà Nội', total_price: 150000, status: 'pending', note: 'Giao buổi sáng' } } },
            'order.updated': { payload: { order: { id: 1, product_name: 'Áo thun', customer_name: 'Nguyễn Văn A', phone: '0900000000', address: 'Hà Nội', total_price: 150000, status: 'completed', note: 'Đã giao' } } },
